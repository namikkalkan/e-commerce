...
function initMap() {
  ...
  if (document.getElementById("map")){
     ...
     /* google.maps.event.addListener(map,'click',function(event){
      ...
      var a = "{{ context.dict|escapejs }}";
      // list of markers here
      var markers = [{
                  coord:{lat:-37.840658,lng:145.000981},
                  content : "<div class ='box small' style='float:left'><img id='surf1' src='static/assets/camping.jpg'></div><div style='float:right; padding: 10px;'><b>Tent for 3 ppl</b><br><b>$40.00</b>",
                  },
                  ...
                  content :"<div class ='box small' style='float:left'><img id='surf1' src='static/assets/kayaking.png'></div><div style='float:right; padding: 10px;'><b>Kayaking boat</b><br><b>$40.00</b>",
                  },
      ]
